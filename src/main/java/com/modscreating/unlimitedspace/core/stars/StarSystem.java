...
public final class StarSystem {
    ...
    /** The star at the given index ({@code 0} = primary, {@code 1..} = companions). */
    public Star star(int starIndex) {
        if (starIndex < 0 || starIndex >= stars.size()) {
            throw new IndexOutOfBoundsException("starIndex " + starIndex + " out of range for " + id.code());
        }
